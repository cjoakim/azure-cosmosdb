...
public class CosmosSqlAsyncMain {
    ...
    protected static Logger logger = LoggerFactory.getLogger(CosmosSqlAsyncMain.class.getSimpleName());
    ...
    public static void main(String[] args) {
    	CosmosSqlAsyncMain p = new CosmosSqlAsyncMain();
